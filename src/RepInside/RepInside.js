...
import './RepInside.css';  // Import custom CSS for this page
...
const RepInside = () => {
  ...
  return (
    <div className="rep-inside-screen">
      <Header />
      <div className="rep-inside-container">
        <h1 className="rep-inside-title">Report Inside</h1>
